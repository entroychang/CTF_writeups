...
// tar czf '$destination' --transform='s|$source|whatever|' $(echo 123) '|' --directory='/tmp' '/$source'
function tar($file)
{
    $filename = $file['name'];
    ...
    print_r("tar czf '$destination' --transform='s|$source|$filename|' --directory='/tmp' '/$source'" . "<br>");
    if ($return === 0) {
